          ...
          children: <Widget>[
            Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(ResponsiveSize.S(AppConstants.creditCardBorderRadiusSize)),
...
class _GlassmorphicBorder extends StatelessWidget {
  _GlassmorphicBorder({
    ...
    required this.width,
  }) : _painter = _GradientPainter(strokeWidth: 2, radius: ResponsiveSize.S(AppConstants.creditCardBorderRadiusSize));
