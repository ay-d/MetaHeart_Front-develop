        ...
        children: <Widget>[
          if (widget.bankName.isNotNullAndNotEmpty)
            Align(
              ...
              child: Padding(
                padding: EdgeInsets.only(right: ResponsiveSize.S(16), top: ResponsiveSize.S(16)),
                child: Text(
                  widget.bankName!,
                  maxLines: 1,
            ...
            child: Row(
              ...
              children: <Widget>[
                if (widget.isChipVisible)
                  Padding(
                    padding: EdgeInsetsDirectional.only(start: ResponsiveSize.S(16)),
                    child: Image.asset(
                      AssetPaths.chip,
                      color: widget.chipColor,
                      width: widget.width == null ? null : widget.width! * 0.1,
                      height: widget.height == null ? null : widget.height! * 0.1,
                      scale: 1,
                    ),
                  ),
              ],
          ...
          SizedBox(height: ResponsiveSize.S(10)),
          Expanded(
            child: Padding(
              padding: EdgeInsetsDirectional.only(start: ResponsiveSize.S(16)),
              child: Text(
              ...
              child: Row(
                ...
                children: <Widget>[
                  Text(
                    ...
                    style: widget.textStyle?.copyWith(fontSize: ResponsiveSize.S(7)) ??
                        defaultTextStyle.copyWith(fontSize: ResponsiveSize.S(7)),
                    textAlign: TextAlign.center,
                  ),
                  SizedBox(width: ResponsiveSize.S(5)),
                  Text(
          ...
          Padding(
            padding: EdgeInsets.only(left: ResponsiveSize.S(16), right: ResponsiveSize.S(16), bottom: ResponsiveSize.S(16)),
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.center,
      ...
      child: Column(
        ...
        children: <Widget>[
          Expanded(
            flex: 2,
            child: Container(
              margin: EdgeInsets.only(top: ResponsiveSize.S(16)),
              height: ResponsiveSize.S(48),
              color: Colors.black,
            ),
          ),
          Expanded(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    ...
                    child: Container(
                      color: Colors.white,
                      child: Padding(
                        padding: EdgeInsets.all(ResponsiveSize.S(5)),
                        child: Text(
                          widget.cvvCode.isEmpty
                              ...
                              : cvv,
                          maxLines: 1,
                          style: widget.textStyle?.copyWith(color: Colors.black) ?? defaultTextStyle,
                        ),
                      ),
                    ),
                  )
