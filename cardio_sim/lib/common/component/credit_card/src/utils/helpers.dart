...
Widget getCardTypeImage({
  ...
  Widget blankSpace =
      SizedBox.square(dimension: ResponsiveSize.S(AppConstants.creditCardIconSize));
      ...
      return CustomCardTypeIcon(
        ...
        cardImage: isKnownCardType
            ? Image.asset(
                ...
                height: ResponsiveSize.S(AppConstants.creditCardIconSize),
                width: ResponsiveSize.S(AppConstants.creditCardIconSize),
