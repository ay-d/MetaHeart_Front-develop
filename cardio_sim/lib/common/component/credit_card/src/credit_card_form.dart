      ...
      child: Column(
        children: <Widget>[
          Visibility(
            ...
            child: Container(
              padding: EdgeInsets.symmetric(vertical: ResponsiveSize.S(8.0)),
              margin: EdgeInsets.only(left: ResponsiveSize.S(16.0), top: ResponsiveSize.S(16.0), right: ResponsiveSize.S(16.0)),
              child: TextFormField(
            ...
            children: <Widget>[
              Visibility(
                ...
                child: Expanded(
                  child: Container(
                    padding: EdgeInsets.symmetric(vertical: ResponsiveSize.S(8.0)),
                    margin: EdgeInsets.only(left: ResponsiveSize.S(16.0), top: ResponsiveSize.S(16.0), right: ResponsiveSize.S(16.0)),                    child: TextFormField(
