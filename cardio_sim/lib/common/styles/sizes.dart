...
const double kWLayoutMaxSize = 1920;
...
const double kMLayoutMaxSize = 768;
...
const double kWBorderRadiusSize = 5.0;
const double kMBorderRadiusSize = 3.0;

//double get kBorderRadiusSize => ResponsiveSize.W(kWBorderRadiusSize);

double get kBorderRadiusSize =>
    ResponsiveData.kIsMobile ? kMBorderRadiusSize : kWBorderRadiusSize;


const double kWBorderWidth = 2.0;
